...
NETLIST_START(tank)
	...
	TTL_7402_DIP(IC_N6)
	TTL_7404_DIP(IC_A7)
	NET_C(VCC, IC_H3.14, IC_J4.14, IC_B6.14, IC_D6.14, IC_E6.14, IC_J6.14, IC_N6.14, IC_A7.14)
	NET_C(GND, IC_H3.7,  IC_J4.7,  IC_B6.7,  IC_D6.7,  IC_E6.7,  IC_J6.7,  IC_N6.7,  IC_A7.7)
	...
	TTL_7408_DIP(IC_L8)
	TTL_7400_DIP(IC_K8)
	NET_C(VCC, IC_B13.14, IC_C13.14, IC_D13.14, IC_E14.14, IC_L12.14, IC_L9.14, IC_L8.14, IC_K8.14)
	NET_C(GND, IC_B13.7,  IC_C13.7,  IC_D13.7,  IC_E14.7,  IC_L12.7,  IC_L9.7,  IC_L8.7,  IC_K8.7)
	...
	NET_C(COIN2_NO, IC_B6.5)
	NET_C(COIN2_NC, IC_B6.1)
	...
	NET_C(IC_D6.13, IC_J6.12, IC_J6.13, IC_J4.1)
	NET_C(IC_J6.9, IC_J4.2)
	NET_C(V128, IC_J4.3, IC_J6.11, IC_E6.9))
	NET_C(IC_J4.5, IC_E6.C)
	...
	NET_C(COINAGE2.1, PLAYTIME.3, R54A.1)
	...
	ALIAS(IC_K12.9, V_RESETQ)
	ALIAS(IC_K12.8, V_RESET)
	...
	NET_C(HRST1Q, IC_L9.9)
	NET_C(VRST1Q, IC_L9.5)
	...
	NET_C(R28.1, IC_C11.2, IC_C11.1, C19.1)
	NET_C(R29.1, IC_C11.12, IC_C11.13, C18.1)
	NET_C(C15.1, IC_C11.3)
	NET_C(C16.1, IC_C11.11)
	NET_C(HIT1Q, IC_C11.4, IC_C11.6)
	NET_C(HIT2Q, IC_C11.8, IC_C11.10)
	...
	NET_C(GND, C33.2, C34.2, C35.2, C36.2)
	NET_C(VCC, R48.1, R49.1, R50.1, R51.1, CR5.K, CR6.K, CR7.K, CR8.K)

	NET_C(P2_RIGHT_UP.2, R55.1)
	NET_C(R55.2, R51.2, CR5.A, C36.1, IC_D15.2, IC_D15.12)
	NET_C(P2_RIGHT_DOWN.2, R53.1)
	NET_C(R53.2, R49.2, CR7.A, C34.1, IC_D15.6, IC_D15.9)
	NET_C(P2_LEFT_UP.2, R54.1)
	NET_C(R54.2, R50.2, CR6.A, C35.1, IC_D15.8, IC_D15.3)
	NET_C(P2_LEFT_DOWN.2, R52.1)
	NET_C(R52.2, R48.2, CR8.A, C33.1, IC_D15.11, IC_D15.5)
	...
	NET_C(IC_L14.9, IC_K13.5, IC_K14.4)
	NET_C(IC_L14.8, IC_K13.5, IC_L13.12, IC_K14.5)
	NET_C(IC_L14.11, IC_K13.11, IC_L13.13, IC_K14.3)
	...
	NET_C(VCC, IC_R10.1, IC_R10.14, IC_R10.14)
	NET_C(GND, IC_R10.9)
	NET_C(H16, IC_R10.13)
	...
	NET_C(IC_R10.16, IC_R19.1, IC_M10.9)
	NET_C(IC_R10.17, IC_R20.1, IC_M10.5)
	NET_C(IC_R10.18, IC_R21.1, IC_M10.11)
	NET_C(IC_R10.19, IC_R22.1, IC_M10.13)
	NET_C(IC_R10.20, IC_R23.1, IC_M10.1)
	NET_C(IC_R10.21, IC_R24.1, IC_M10.3)
	NET_C(IC_R10.22, IC_R25.1, IC_N13.11)
	NET_C(IC_R10.23, IC_R26.1, IC_N13.9)
	...
	NET_C(GND, IC_K7.7,  IC_E7.7,  IC_H7.7,  IC_F7.8,  IC_H7.2,  IC_H7.12, IC_F7.8, IC_F7.7, IC_F7.10, IC_F7.5, IC_F7.11)

	NET_C(IC_F7.8, IC_F7.13)
	NET_C(MEV, IC_A11.10)
	NET_C(V8, IC_A11.9)
	...
	NET_C(GND, IC_J11.7,  IC_J11.7,  IC_L11.8)
	...
	NET_C(VCC, IC_M9.13, IC_M9.1, IC_N9.13, IC_N9.1, IC_M11.13, IC_M11.1, IC_N11.13, IC_N11.1, IC_N11.4)
	...
	NET_C(IC_A1.15, IC_B1.7, IC_M1.3)
	...
	ALIAS(LAD1AQ, IC_A3.1)
	ALIAS(LDH1BQ, IC_B3.1)
	...
	TTL_7410_DIP(IC_M4)
	TTL_7400_DIP(IC_C5)
	NET_C(VCC, IC_M1.14, IC_M2.14, IC_C1.14, IC_J3.14, IC_A6.14, IC_K3.14, IC_L3.14, IC_F3.14, IC_C6.14, IC_M5.14, IC_M4.14, IC_C5.14)
	NET_C(GND, IC_M1.7,  IC_M2.7,  IC_C1.7,  IC_J3.7,  IC_A6.7,  IC_K3.7,  IC_L3.7,  IC_F3.7,  IC_C6.7,  IC_M5.7,  IC_M4.7,  IC_C5.7)

	NET_C(CLOCKQ, IC_A6.5)
	ALIAS(CLOCK2, IC_A6.5)
	NET_C(IC_A6.6, IC_A5.2, IC_A5.2, IC_F3.3, IC_C3.2, IC_D3.2)
	...
	TTL_74107_DIP(IC_L1)
	TTL_7408_DIP(IC_F2)
	NET_C(VCC, IC_D1.14, IC_E1.14, IC_H1.16, IC_J1.16, IC_F1.16, IC_H2.16, IC_J2.16, IC_L1.14, IC_F2.14)
	...
	TTL_7474_DIP(IC_D2)
	TTL_7474_DIP(IC_E2)
	NET_C(VCC, IC_K1.14, IC_N4.14, IC_L2.14, IC_K2.14, IC_K1.14, IC_N3.14, IC_M3.14, IC_D2.14, IC_E2.14)
	NET_C(GND, IC_K1.7,  IC_N4.7,  IC_L2.7,  IC_K2.7,  IC_K1.7,  IC_N3.7,  IC_M3.7,  IC_D2.7,  IC_E2.7)

	NET_C(VCC, R4.1, R5.1, R6.1, R7.1, R8.1, R9.1, R10.1, R11.1)
	NET_C(VCC, IC_H2.7, IC_H2.10, IC_J2.10, IC_J2.3, IC_J2.4, IC_J2.5, IC_L1.1, IC_L1.4, IC_L1.8, IC_L1.11, IC_N3.1, IC_H2.1, IC_J2.1)
	NET_C(VCC, IC_F1.7, IC_F1.10, IC_H1.10, IC_H1.3, IC_H1.4, IC_H1.5, IC_H1.6, IC_J1.3, IC_J1.5, IC_J1.6)
	NET_C(VCC, IC_D1.1, IC_D1.13, IC_E1.1, IC_H2.1, IC_J2.1)
	...
	NET_C(IC_J4.12, IC_D2.1, IC_D2.13, IC_E2.1, IC_E2.13, IC_E1.13)
	...
	NET_C(ROM_D0, IC_D2.2)
	NET_C(ROM_D1, IC_E2.2)
	NET_C(ROM_D2, IC_E2.12)
	NET_C(ROM_D3, IC_D2.12)
	NET_C(ROM_D4, IC_D1.2)
	NET_C(ROM_D5, IC_D1.12)
	NET_C(ROM_D6, IC_E1.2)
	NET_C(ROM_D7, IC_E1.12)
	...
	NET_C(GND, IC_E4.7,  IC_D4.7,  IC_D5.7,  IC_E7.7,  IC_H4.8,  IC_J4.8,  IC_F5.8,  IC_H5.8,  IC_J5.8)

	TTL_74107_DIP(IC_L5)
	TTL_7486_DIP(IC_K4)
	TTL_7402_DIP(IC_K5)
	TTL_7408_DIP(IC_F4)
	NET_C(VCC, IC_L5.14, IC_K4.14, IC_K5.14, IC_F4.14)
	NET_C(GND, IC_L5.7,  IC_K4.7,  IC_K5.7,  IC_F4.7)
	...
	NET_C(VCC, IC_H4.1, IC_J4.1, IC_F5.1, IC_H5.1, IC_J5.1, IC_N3.13, IC_L5.8, IC_L5.11, IC_L5.1, IC_L5.4, IC_E5.10)
	NET_C(GND, C111.2, IC_J4.6, IC_J5.4)

	NET_C(FIRE2Q, IC_M4.1, IC_M4.10)
	NET_C(VLD2, IC_M4.13)
	NET_C(IC_M4.12, IC_E4.3, IC_D4.3, IC_E4.11, IC_D4.11, IC_D5.3, IC_D5.11, IC_E5.3, IC_E5.11)
	NET_C(IC_E5.13, IC_D5.4, IC_D5.10, IC_E5.4)

	NET_C(EXPL2, IC_H3.11)
	NET_C(IC_H3.10, IC_E4.1, IC_D4.1, IC_E4.13, IC_D4.13)
	...
	// Boom Com
	TTL_9602_DIP(IC_N14)
	NET_C(VCC, IC_N14.16, IC_N14.3, IC_N14.5, R38.2)
	...
	// Noise Generation
	UA741_DIP8(IC_NOISE_OP)
	NET_C(V12, IC_NOISE_OP.7, R71.1, R70.1)
	NET_C(R71.2, C40.1, C43.1, R70.2, R73.1, IC_NOISE_OP.3)
	NET_C(GND, C43.2, R73.2, C38.1)
	NET_C(C38.2, R69.1, C39.1, IC_NOISE_OP.2)
	NET_C(IC_NOISE_OP.6, R69.2, C39.2)
	ALIAS(NOISE, IC_NOISE_OP.6)
	...
	NET_C(V12, IC_M15.8, IC_N15.8, R73M1.1, Q27.C, R100M1.1, Q30.E)
	NET_C(GND, C54M1.2, C51M1.2, C53M1.2, C55M1.2, R78M1.2, IC_L15.1)
	...
	NET_C(R73M1.2, R74M1.2, R75M1.2, R76M1.2, C54M1.1, Q27.B)
	NET_C(C54M2.2, MOTOR1_VOL.1)
	...
	NET_C(V12, IC_H15.8, IC_F15.8, R72M2.1, Q31.C, R102M2.1, Q31.E)
	...
	NET_C(R72M2.2, R71M2.2, R70M2.2, R69M2.2, C49M2.1, Q31.B)
