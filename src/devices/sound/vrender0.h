...
private:
	...
	struct channel_t
	{
		...
		memory_access<23, 1, 0, ENDIANNESS_LITTLE>::specific *Cache;
	...
	memory_access<23, 1, 0, ENDIANNESS_LITTLE>::specific m_texcache;
	memory_access<23, 1, 0, ENDIANNESS_LITTLE>::specific m_fbcache;
	memory_access<23, 1, 0, ENDIANNESS_LITTLE>::specific *m_texcache_ctrl;
