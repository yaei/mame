...
//
	...
	memory_access<24, 0, 0, ENDIANNESS_BIG>::specific m_oprogram8;
	memory_access<24, 1, 0, ENDIANNESS_BIG>::specific m_oprogram16;
	memory_access<32, 2, 0, ENDIANNESS_BIG>::specific m_oprogram32;
