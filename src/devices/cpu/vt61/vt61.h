...
private:
	...
	memory_access<10, 1, -1, ENDIANNESS_LITTLE>::specific m_program_cache;
	memory_access<16, 0,  0, ENDIANNESS_LITTLE>::specific m_memory_cache;
	memory_access< 6, 0,  0, ENDIANNESS_LITTLE>::specific m_idr_cache;
